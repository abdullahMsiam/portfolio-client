...
const Skills = () => {
    return (
        <div className='pb-8'>
            <p className='text-center mt-9 text-4xl pb-10'>- - | |  - -</p>
            <h1 className='text-center text-5xl font-bold'>My Expertise Zone</h1>
            <div>
                <div className='grid grid-cols-2 justify-items-center gap-5 w-3/4 mx-auto mt-9'>
                    <div className="card w-96 shadow-xl image-full transition duration-500 transform  hover:scale-105">
                    ...
                    <div className="card w-96 bg-neutral-800   shadow-xl image-full transition duration-500 transform  hover:scale-105">
