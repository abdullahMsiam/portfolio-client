...
const AboutMe = () => {
    return (
        <div>
            ...
            <div className='grid grid-cols-2 my-auto gap-2  mt-6'>
                <div className='w-full'>
                    ...
                    <div className='mt-2 flex gap-2 w-full'>
                        ...
                        <div>
                            <h2> <span className='font-bold opacity-50'>Last Name:</span> <span className='font-bold ms-1'>Muhammad Siam</span> </h2>
                    ...
                    <Link to="https://drive.google.com/file/d/1QQIDUDacpVtKgD4IdudYkf4Q35NWpijY/view?usp=drive_link">
                        <button className='mt-3 btn btn-outline bg-neutral-800 hover:bg-[#ffde29] hover:text-black rounded-full text-white'>Download CV</button>
                    </Link>
                </div>
