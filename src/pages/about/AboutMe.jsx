        ...
        <div className='pb-4'>
            ...
            <div className='grid md:grid-cols-2 my-auto gap-3 mt-6 content-center'>
                <div className='w-11/12 md:w-full'>
                    ...
                    <div className='mt-3 md:flex gap-2 w-full ms-5 md:ms-3 md:text-start '>
                        <div>
                            ...
                            <h2 className='mb-1'> <span className='font-bold opacity-50'>Email:</span> <span className='font-bold ms-1'>abdullahmuhammadsiam@gmail.com</span> </h2>
                        </div>
                        <div>
                    ...
                    <Link to="https://drive.google.com/file/d/1QQIDUDacpVtKgD4IdudYkf4Q35NWpijY/view?usp=drive_link">
                        <button className='mt-6 me-4 text-xs mb-5 btn border-[#ffde29] bg-neutral-900 duration-500 hover:scale-105 focus:scale-95 hover:bg-[#ffde29] hover:text-black rounded-full text-white w-full'>--Download CV--</button>
                    </Link>
                </div>
