...
const MailSend = () => {
    ...
    return (
        <div>
            ...
            <h1 className='text-center text-5xl font-bold mb-4'>-- Connect Me --</h1>
                        ...
                        <div className="card-body">
                            ...
                            <form ref={form} onSubmit={sendEmail} className='text-black'>
                                <div className="form-control">
                                    ...
                                    <input type="text" placeholder="Name" name='userName' className="input rounded-full bg-neutral-800 text-white focus:border-white" />
                                </div>
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text text-white font-bold text-2xl mt-2">Email</span>
                                    </label>
                                    <input type="email" placeholder="Email" name='email' className="input rounded-full bg-neutral-800 text-white focus:border-white" />
                                </div>
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text text-white font-bold text-2xl mt-2">Message</span>
                                    </label>
                                    <textarea type="text" placeholder="Message" name='message' className="textarea-lg border-0 focus:border-0 rounded-xl bg-neutral-800 text-white" />
                                </div>
